...
export const login = param => {
    return axios.post(`${API_REQUEST_URL}userLogin?LoginID`, {
        LoginID: param.name,
        LoginPW: param.password,
        uuid: param.uuid
...
export const setStandbyFromDone = param => {
    if(param.restart === 1) {
        return {
            data: null,
        };
    }
    return axios.post(`${API_REQUEST_URL}setInitState`, {
        simulatorID: param.simulatorID
    }, getAxiosConfigWithAuthHeaders());
};
